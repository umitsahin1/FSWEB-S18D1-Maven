...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_2 = "SELECT o.* AS islem_ogrno FROM ogrenci AS o INNER JOIN islem AS i ON o.ogrno = i.ogrno;";
    ...
    String QUESTION_4 = "SELECT o.ad,o.soyad, COUNT(o.ogrno) FROM ogrenci AS o INNER JOIN islem AS i ON o.ogrno = i.ogrno WHERE (sinif ='10A' or sinif ='10B') GROUP BY o.ad,o.soyad;";
    ...
    String QUESTION_9 = "SELECT o.ad,o.soyad, COUNT(o.ogrno) \n" +
            "FROM ogrenci AS o\n" +
